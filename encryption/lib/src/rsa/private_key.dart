...
class RSAPrivateKey implements PrivateKey {
  ...
  /// Verilen parametrelere göre bi tane [RSAPrivateKey] oluşturuyoruz.
  RSAPrivateKey(BigInt modulus, BigInt exponent, BigInt p, BigInt q)
      : _privateKey = pointy.RSAPrivateKey(modulus, exponent, p, q);

  /// Verilen String'e göre bi tane [RSAPrivateKey] oluşturuyoruz.
  ...
  /// Verilen PEM-String'e göre bi tane [RSAPrivateKey] oluşturuyoruz.
  ...
  /// [RSAPublicKey] kullanarak doğrulanabilen mesajı imzalıyoruz
  @override
  @Deprecated(
      'SHA-256 imzası oluşturmak için createSHA256Signature() metodunu kullanın')
  String createSignature(String message) =>
      base64.encode(createSHA256Signature(utf8.encode(message) as Uint8List));

  /// SHA-256 ile [RSAPublicKey] kullanarak doğrulanabilen mesajı imzalıyoruz
  @override
  Uint8List createSHA256Signature(Uint8List message) =>
      _createSignature(message, 'SHA-256/RSA');

  /// SHA-512 ile [RSAPublicKey] kullanarak doğrulanabilen mesajı imzalıyoruz
  @override
  ...
  /// [RSAPublicKey] kullanılarak şifrelenmiş mesajın şifresini çözüyoruz
  ...
  /// [RSAPrivateKey] ile ilişkili [RSAPublicKey] çağırıyoruz
  @override
  RSAPublicKey get publicKey =>
      RSAPublicKey(_privateKey.modulus!, BigInt.parse('65537'));

  /// [RSAPrivateKey] 'i PointyCastle RSAPrivateKey olarak export ediyoruz
  @override
